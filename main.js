    ...
    var tetris = {
        ...
        initNextShape: function() {
            ...
            try {
                ...
                throw new Error("Não foi possível criar a próxima peça. " + e);
            }    
        },
        ...
        shiftTempShapes: function(){
            try {
                ...
                throw new Error("Não foi possível mudar ou inicializar : " +e);
            }
        },
        initTimer: function(){
            var me = this;
        ...
        initLevelScores: function(){
            ...
            for (var i = 1; i <= this.numLevels; i++){
                this['level' + i] = [c * 1000, 40 * i, 5 * i]; //para o proximo nível, pontuação de linha,, 
                c = c + c;
            }
        },
        setInfo: function(el){
        ...
        gameOver: function(){
            this.clearTimers();
            this.canvas.innerHTML = "<h1>FIM DO JOGO</h1>";
        },
        play: function(){
            var me = this;
            if (this.timer === null){
        ...
        rotate: function(){
            if (this.curShapeIndex !== 6) {
                ...
                if (this.checkMove(this.curX, this.curY, temp)) {
                    ...
                    throw new Error ("Não foi possível girar!");
                }
            }
        },
